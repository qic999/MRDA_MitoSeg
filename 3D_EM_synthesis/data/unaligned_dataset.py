...
class UnalignedDataset(BaseDataset):
    ...
    def __init__(self, opt):
        ...
        self.dir_A = os.path.join(opt.dataroot, opt.phase, 'label_3')
        self.dir_B = os.path.join(opt.dataroot, opt.phase, 'volume_3')
    ...
    def __getitem__(self, index):
        ...
        # C_path = self.B_paths[random.randint(0, len(self.B_paths)-1)]
