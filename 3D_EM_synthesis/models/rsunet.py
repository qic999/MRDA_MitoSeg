...
class UpsampleMod(nn.Module):
    ...
    """
    def __init__(self, in_channels, out_channels, up=(1.0,2.0,2.0), mode='bilinear',
...
class OutputMod(nn.Module):
    ...
    def __init__(self, in_channels, out_spec, kernel_size=1):
        ...
        for k, v in self.spec.items():
         ...
         """
        padding = pad_size(kernel_size, 'same')
        self.conv = Conv(in_channels, out_spec, kernel_size,
                        stride=1, padding=padding, bias=True)
...
class RSUNet(nn.Module):
    ...
    def __init__(self, in_channel, out_channel, depth,
        ...
        # Output by spec.
        # self.out_spec = out_channel
        self.output = OutputMod(in_channels, out_channel)
