...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--model_dir', type=str, default='', help='models are saved here')
        parser.add_argument('--finetune', action='store_true', help='for finetune')
        ...
        parser.add_argument('--use_vgg_loss', action='store_true', help='enable training with vgg loss.')
        # model parameters
        ...
        parser.add_argument('--netD_P', type=str, default='basic', help='specify discriminator architecture [basic | n_layers | pixel]. The basic model is a 70x70 PatchGAN. n_layers allows you to specify the layers in the discriminator')
        ...
        parser.add_argument('--patchSize', type=list, default=(4, 64, 64), help='then crop to this size')
