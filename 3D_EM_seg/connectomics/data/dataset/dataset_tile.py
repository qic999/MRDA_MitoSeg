...
class TileDataset(torch.utils.data.Dataset):
    ...
    def loadchunk(self):
        ...
        volume = [tileToVolume(self.json_volume['image'], coord_p, self.coord_m,\
                             tile_sz=self.json_volume['tile_size'],tile_st=self.json_volume['tile_st'],  #  self.json_volume['tile_size'] = 4096, self.json_volume['tile_st'] = [0, 0]
                              tile_ratio=self.json_volume['tile_ratio'])] # (121, 2986, 2987)   "tile_ratio": 1 
        label = None
        ...
        # save_path = '/braindat/lab/qic/seg_code/synthesis-assist-seg/2k/volume.tif'
        # volwrite(save_path, volume[0])
        # import pdb
        # pdb.set_trace()
