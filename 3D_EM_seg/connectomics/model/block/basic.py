...
#                     dilation=(1, 1, 1), padding=(1, 1, 1), bias=True, pad_mode='replicate', norm_mode='', act_mode='',
#                     return_list=False):
...
def conv3d_norm_act(in_planes, out_planes, kernel_size=(3, 3, 3), stride=1, groups=1,
                    dilation=(1, 1, 1), padding=(1, 1, 1), bias=False, pad_mode='replicate',
                    norm_mode='bn', act_mode='relu', return_list=False):

    layers = []
    layers += [nn.Conv3d(in_planes, out_planes, kernel_size=kernel_size, stride=stride,
